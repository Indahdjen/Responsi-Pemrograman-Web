...
<head>
	...
	<link rel="stylesheet" type="text/css" href="lihat-data.css">
	<link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
</head>
	<script>
    	alert("Ini adalah tampilan data peserta lomba karya seni");
	</script>
<body>
	<header>
		<h1>Data Peserta Lomba<br>&copy; Indah Nuraini A. M. Djen | 2100018204</h1>
	</header>
